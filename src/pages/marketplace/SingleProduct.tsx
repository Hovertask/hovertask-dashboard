...
export default function SingleProductPage() {
	...
	useEffect(() => {
		...
		imageCarouselRef.current?.addEventListener(
			"scroll",
			updateActiveIndexOnScrollEnd,
		);
		return () => {
			imageCarouselRef.current?.removeEventListener(
				"scroll",
				updateActiveIndexOnScrollEnd,
			);
		};
					...
					<>
						...
						<div>
							<div className="relative overflow-hidden space-y-3">
								...
								<div
									style={{
										gridTemplateColumns: `repeat(${images.length + 1}, 14px)`,
									}}
						...
						<div className="space-y-3">
							...
							<p className="font-light">
								...
								Commission Details:You will earn a reseller commission of
								₦10,000 every time someone purchases this product using your
								unique link. Take Action Now!Click the button below and start
								earning today!
							</p>
							<div>
							...
							<div className="flex justify-between flex-wrap gap-2 items-end">
								<div>
									...
									<p className="font-light">
										Click the button to start earning today.
									</p>
								</div>
